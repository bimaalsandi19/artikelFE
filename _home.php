<div class="container-fluid">
    ...
    <?php
        ...
        $apiUrl = "http://localhost:8000/api/page?limit={$limit}&offset={$offset}";
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="index.php?page=delete&id=<?php echo $row['id']?>"  onclick="return confirm='Apakah anda yakin untuk hapus data ini ?'"  class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                </tr>       
